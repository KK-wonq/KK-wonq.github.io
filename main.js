...
const portfolioData = [
  ...
  },
  {
    ...
    images: [
      ...
      { src: "port2_images/wazuh,go,pmm/wazuh-nail.png", caption: "Wazuh" },
...
https://github.com/juice-shop/juicy-chat-bot/blob/master 이 사이트로 가면 챗봇의 js파일을 확인할 수 있습니다.</p>
  ...
  },
  {
    ...
    htmlContent: `
      ...
      <img src="part3-image/hack/hacking_2.png" style="width:100%; border-radius:8px; margin-top:10px;" alt="프로젝트 개요">
